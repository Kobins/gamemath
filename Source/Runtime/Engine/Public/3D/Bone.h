...
public:
	...
	const std::size_t GetProperty() const { return _Property; }
	void SetProperty(const std::size_t& InProperty) { _Property = InProperty; }
...
private:
	...
	std::size_t _Property = 0x02 | 0x08 | 0x10;
};
